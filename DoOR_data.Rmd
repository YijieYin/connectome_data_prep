...
```{r}
write.csv(door_response_matrix, 'data/DoOR/door_response_matrix.csv')
write.csv(door_mappings, 'data/DoOR/door_receptor_mappings.csv')
write.csv(ab2B, 'data/DoOR/door_chemical_meta.csv')
```
