...
python activation_maximisation.py --inprop_path $inprop_path --meta_path $meta_path --target_index $target_index --num_layers $num_layers --optimised_input_path $optimised_input_path --output_path $output_dir --array_id $array_id
